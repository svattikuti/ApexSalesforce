...
- [Udemy search: Salesforce SOQL](https://www.udemy.com/courses/search/?q=salesforce%20soql) - optional paid-course search checked on 2026-06-11. Use it for extra practice only after checking that a course was updated recently and covers relationship queries, aggregate queries, bind variables, and bulk-safe Apex.
- [Udemy search: Salesforce Apex developer](https://www.udemy.com/courses/search/?q=salesforce%20apex%20developer) - optional paid-course search checked on 2026-06-11. Prefer courses that use current Salesforce CLI commands, tests, triggers, selectors, and services.
...
Use official docs for syntax and platform rules. Use Udemy for additional walkthrough repetition, not as the final authority. Use the recipe repos after this project feels comfortable, because they are broader reference libraries rather than guided lessons.
